...
`Hello, world!
  apple  juice_`, [
    ...
    { line: 1, character: 2, content: "apple", tokenType: enc("description"), tokenModifiers: 0 },
    { line: 1, character: 9, content: "juice_", tokenType: enc("description"), tokenModifiers: 0 }
  ]],
  [
