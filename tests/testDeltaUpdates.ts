...
const deltaTestParams: [
  ...
  //     { line: 0, character: 11, content: ":)", tokenType: enc("description"), tokenModifiers: 0 },
  //   ], [{
  //     range: {
  ...
  //     { line: 0, character: 10, content: ":)", tokenType: enc("description"), tokenModifiers: 0 },
  //   ]
  // ]
];
    ...
    test(testName, () => {
      ...
      for (const changeEvent of changeEvents)
        [newTokens, spliceShift] = deltaChangeTokens(
          oldTokens, changeEvent, spliceShift
        );
